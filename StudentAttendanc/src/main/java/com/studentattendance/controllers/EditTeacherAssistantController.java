...
public class EditTeacherAssistantController implements Initializable {
    @FXML
    ...
    public void onEditTeacherAssistant() {
        if (isValid()) {
            model.getRegisteredTeacherAssistant().setName(name.getText());
            model.getRegisteredTeacherAssistant().setPhoneNumber(phoneNumber1.getText(), phoneNumber2.getText());
            model.getRegisteredTeacherAssistant().setAddress(address.getText());
            model.getRegisteredTeacherAssistant().setUserName(userName.getText());
            model.getRegisteredTeacherAssistant().setPassword(password.getText());
            MyAlert.informationAlert("The teacher assistant has been updated successfully", "Done", null);
        }
        else {
