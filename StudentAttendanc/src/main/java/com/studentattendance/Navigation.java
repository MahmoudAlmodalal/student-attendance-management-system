...
public class Navigation {
    ...
    public final String SYSTEM_MANAGER_FXML = "views/systemManager.fxml";
    ...
    public final String EDIT_SYSTEM_MANAGER_FXML = "views/editSystemManager.fxml";
    public final String SHOW_STUDENT_FXML = "views/showStudent.fxml";
    public final String SHOW_LECTURE_FXML = "views/showLecture.fxml";
    public final String EDIT_TEACHER_ASSISTANT_FXML = "views/editTeacherAssistant.fxml";
